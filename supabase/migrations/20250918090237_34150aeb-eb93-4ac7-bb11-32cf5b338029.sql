...
-- Create company merge requests table
...
-- Function to set verification code for merge requests
...
-- Create trigger to set verification code
CREATE TRIGGER set_verification_code_trigger
  BEFORE INSERT ON public.company_merge_requests
  FOR EACH ROW
  EXECUTE FUNCTION set_merge_request_verification_code();
